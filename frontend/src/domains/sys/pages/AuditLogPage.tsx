import { CameraOutlined, CloseCircleOutlined, FilterOutlined, ReloadOutlined } from "@ant-design/icons";
                            ...
                            {filterTags.length > 0 && (
                                ...
                                >
                                    ...
                                    {filterTags.map((tag) => (
                                        ...
                                        >
                                            <span style={{ color: token.colorTextSecondary }}>{tag.label}:</span>{" "}
                                            {tag.value}
                                        </Tag>
                                    ))}
