...
import type { CreateOrgParams, Organization } from "@/domains/usr/types";
 ...
 */
const OrgFormCard: React.FC<OrgFormCardProps> = ({ initialValues, disabled = false, form: externalForm, onFinish }) => {
