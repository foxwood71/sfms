...
export const createCodeGroup = async (groupData: Partial<CodeGroup>) => {
	const response = await http.post<APIResponse<CodeGroup>>(
		"/cmm/codes",
		groupData,
	);
	return response.data;
...
export const updateCodeGroup = async (
	...
	const response = await http.patch<APIResponse<CodeGroup>>(
		`/cmm/codes/${groupCode}`,
		groupData,
	);
	return response.data;
...
export const getCodeDetails = async (groupCode: string) => {
	const response = await http.get<APIResponse<CodeGroup>>(
		`/cmm/codes/${groupCode}`,
	);
...
export const createCodeDetail = async (detailData: Partial<CodeDetail>) => {
	...
	const response = await http.post<APIResponse<CodeDetail>>(
...
export const getAttachmentInfo = async (fileId: string) => {
	const response = await http.get<APIResponse<Attachment>>(
...
export const updateAttachmentMetadata = async (
	...
	const response = await http.patch<APIResponse<Attachment>>(
		`/cmm/attachments/${fileId}`,
		updateData,
	);
	return response.data;
