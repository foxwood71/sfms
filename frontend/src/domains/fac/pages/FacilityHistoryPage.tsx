import { FileProtectOutlined, HistoryOutlined, FolderOpenOutlined } from "@ant-design/icons";
import { PageContainer, ProCard, ProTable } from "@ant-design/pro-components";
import { Tabs, Tag, Space, Typography, theme } from "antd";
...
const FacilityHistoryPage: React.FC = () => {
    ...
    return (
        <PageContainer 
            ...
            childrenContentStyle={{ height: LAYOUT_CONSTANTS.CONTENT_HEIGHT, overflow: "hidden" }}
        >
            <ProCard
                tabs={{
                    activeKey: activeTab,
                    ...
                    items: [
                        {
                            ...
                            children: (
                                <ProTable
                                    ...
                                    columns={[
                                        { title: t("fac.history.file_type"), dataIndex: "type", width: 120, render: (val: string) => <Tag color="blue">{val}</Tag> },
                                        { title: t("fac.history.file_name"), dataIndex: "name" },
                                        { title: t("fac.history.upload_date"), dataIndex: "date", width: 150 },
                                        { title: t("fac.history.uploader"), dataIndex: "user", width: 120 },
                                    ]}
                            ...
                            children: (
                                <ProTable
                                    ...
                                    columns={[
                                        ...
                                        { title: t("sys.audit.action_type"), dataIndex: "action", width: 100 },
