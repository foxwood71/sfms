...
import { getFacilitiesApi, updateFacilityApi, createFacilityApi } from "../api";
						...
						<div style={{ 
							...
							<Space size={24}>
								<Space direction="vertical" size={2}>
									<span style={{ fontSize: "12px", color: token.colorTextSecondary }}>{t("fac.facility.name")} / {t("fac.facility.code")}</span>
									<Input.Search
