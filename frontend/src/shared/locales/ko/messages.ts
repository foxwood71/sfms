...
export const KO_MESSAGES = {
	...
	fac: {
		...
		facility: {
			title: "시설물 관리",
			list_title: "시설물 목록",
			new_facility: "신규 시설 등록",
			detail_title: "시설 상세 정보",
			code: "시설 코드",
			name: "시설명",
			address: "주소",
			category: "시설 유형",
		...
		space: {
			title: "공간 관리",
			tree_title: "공간 계층도",
			detail_title: "공간 상세 정보",
			new_space: "신규 공간 등록",
			select_facility_placeholder: "시설을 먼저 선택하세요",
			go_to_facility_list: "시설물 등록하러 가기",
			code: "공간 코드",
			name: "공간명",
			parent: "상위 공간",
			parent_placeholder: "상위 공간을 선택하세요 (미선택 시 최상위)",
			add_sub: "하위 추가",
			type: "물리적 유형",
			function: "기능적 용도",
			area: "면적 (㎡)",
			restricted: "보안 구역",
			org: "관리 책임 부서",
			hint_msg: "이 공간은 장비(EQP) 및 자산 관리의 기본 단위가 됩니다.",
		},
		history: {
			title: "자료 및 이력 관리",
			doc_tab: "관련 자료 (도면/매뉴얼)",
			history_tab: "변경 및 점검 이력",
			file_name: "파일명",
			file_type: "구분",
			upload_date: "등록일",
			uploader: "등록자",
