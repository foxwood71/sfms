...
| **INI** |	`rogalmic.vscode-ini` | Ini for VS Code |
...
| **NGINX Config** | `william-melo.nginx-conf` | default.conf 등 설정 파일의 문법 강조 및 자동 완성 지원 |
| **MinIO**	| `minio.minio`	| MinIO 버킷 생성 및 파일 업로드/관리 공식 도구 |
